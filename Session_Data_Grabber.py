...
event_list = {'Year': [year], 'Grand_Prix': [grand_prix], 'Event_List': [grand_prix_day], 'Event_ID': [event_id]}
...
joined_data.to_excel("C:/Users/johnp/Downloads/SessionData.xlsx")
